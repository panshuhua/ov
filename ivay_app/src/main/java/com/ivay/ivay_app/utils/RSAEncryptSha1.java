...
//		"3MIHjbk2GK4tMKXs0tTWiGAWd71O1R6+zB+pd7jy" + "\r";
	...
	private static final RSAEncryptSha1 rsaEncrypt;
	private static final Base64 base64 = new Base64();
	static {
		rsaEncrypt= new RSAEncryptSha1();
		//加载公钥
		try {
			rsaEncrypt.loadPublicKey(RSAEncrypt.loadPublicKeyByFile(SpringUtil.getResourceFile()));
		...
		//加载私钥
		try {
			rsaEncrypt.loadPrivateKey(RSAEncrypt.loadPrivateKeyByFile(SpringUtil.getResourceFile()));
