...
public class XEbayRepayAPIServiceImpl implements XEbayRepayAPIService {
    ...
    @Override
    public EbayVirtualAccountRsp registVitualAccount(String mapId, Number amount, String customerName)
        throws Exception {
    ...
    @Override
    public EbayVirtualAccountRsp updateVitualAccount(String mapId, Number amount, String customerName, String accountNo)
        throws Exception {
    ...
    private EbayVirtualAccountRsp callCollectionApi(EbayVirtualAccountReq ebayVirtualAccountReq, XEbayData data)
        throws IOException {
     ...
     * @param transfersRsp
     */
    private void loggerVirtualAccountInfo(EbayVirtualAccountReq ebayVirtualAccountReq,
        EbayVirtualAccountRsp ebayVirtualAccountRsp, XEbayData data) {
