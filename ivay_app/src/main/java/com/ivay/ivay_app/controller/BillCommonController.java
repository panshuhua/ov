...
public class BillCommonController {
    ...
    public static String testHttp() {
        ...
        String encryptStr = RequestId + "|" + RequestTime + "|" + PartnerCode + "|" + Operation + "|" + BankNo + "|"
            + AccNo + "|" + AccType;
    ...
    @ApiOperation(value = "Fpt发送短信")
    // @RequestMapping(value = "star/sendsms", method = {RequestMethod.GET})
    @GetMapping("star/sendMsgByFpt/{to}/{text}")
    @ResponseBody
    public String sendMsgByFpt(@PathVariable String text, @PathVariable String to) {
        // 获取access_token
        ...
        System.out.println("获取token返回：" + responseBody);
        ...
        System.out.println(JsonUtils.objectToJson(sendReq));
        ...
        System.out.println("发送短信返回：" + responseBody);
