...
public class SysVariable {
    ...
    // 接口对接
    public static final String API_ACC_TYPE = "1";
    public static final String API_PARTNER_CODE = "FINTECH";
    public static final String API_REQUEST_ID_PREFIX = API_PARTNER_CODE + "BK";
