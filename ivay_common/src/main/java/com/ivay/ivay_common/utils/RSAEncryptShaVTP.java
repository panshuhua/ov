...
public class RSAEncryptShaVTP {
    private static final Logger logger = LoggerFactory.getLogger(RSAEncryptShaVTP.class);
    ...
    public static final String DEFAULT_PUBLIC_KEY =
        ...
        "MIGeMA0GCSqGSIb3DQEBAQUAA4GMADCBiAKBgHYh6nL5kXBCJxVviD9SqhLLa1CE" + "\r"
            ...
            + "x+NX1Q/ELA/Ke7WzPeux2Y/1SEuv5TVnAuOa70bbcT4xU5O2PfLglVsfvBrzpDDl" + "\r" + "Kqd07bzMkLLD184jAgMBAAE="
            + "\r";
    ...
    private static final RSAEncryptShaVTP RSA_ENCRYPT;
    private static final Base64 BASE_64 = new Base64();

    static {
        RSA_ENCRYPT = new RSAEncryptShaVTP();
        // 加载公钥
        try {
            RSA_ENCRYPT.loadPublicKey(RSAEncryptVTP.loadPublicKeyByFile(SpringUtil.getResourceFile()));
            logger.info("加载公钥成功");
        } catch (Exception e) {
        ...
        // 加载私钥
        try {
            RSA_ENCRYPT.loadPrivateKey(RSAEncryptVTP.loadPrivateKeyByFile(SpringUtil.getResourceFile()));
            logger.info("加载公钥成功");
        } catch (Exception e) {
            logger.error("加载公钥失败" + e.getMessage());
        }
