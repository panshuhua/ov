...
public class RSAEncryptCollection extends RSAEncrypt {
    ...
    private static final String PRIVATE_KEY = "pkcs8_private0527.pem"; // dev 创建/更新虚拟账号时加密使用的私钥
    // private static final String PRIVATE_KEY = "pkcs8_partner_privatekey.pem"; //prov

    private static final String PUBLIC_KEY = "bk_public_key.pem"; // dev 还款回调接口解密时使用的公钥
